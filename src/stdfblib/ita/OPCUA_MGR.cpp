...
EMGMResponse OPCUA_MGR::initialize() {
  ...
  if (uaServer != nullptr) {
    if (createIEC61499MgmtObject(uaServer) != EMGMResponse::Ready)
...
EMGMResponse OPCUA_MGR::createIEC61499MgmtObject(UA_Server *paServer) {
  ...
  if (defineIEC61499MgmtObjectType(paServer) != EMGMResponse::Ready)
    return eRetVal;
  if (addCreateResourceMethod(paServer) != EMGMResponse::Ready)
    return eRetVal;
  if (addWriteDeviceMethod(paServer) != EMGMResponse::Ready)
    return eRetVal;
  if (addWriteResourceMethod(paServer) != EMGMResponse::Ready)
    return eRetVal;
  if (addStartDeviceMethod(paServer) != EMGMResponse::Ready)
    return eRetVal;
  if (addStartResourceMethod(paServer) != EMGMResponse::Ready)
    return eRetVal;
  if (addStopDeviceMethod(paServer) != EMGMResponse::Ready)
    return eRetVal;
  if (addStopResourceMethod(paServer) != EMGMResponse::Ready)
    return eRetVal;
  if (addResetDeviceMethod(paServer) != EMGMResponse::Ready)
    return eRetVal;
  if (addResetResourceMethod(paServer) != EMGMResponse::Ready)
    return eRetVal;
  if (addKillDeviceMethod(paServer) != EMGMResponse::Ready)
    return eRetVal;
  if (addKillResourceMethod(paServer) != EMGMResponse::Ready)
    return eRetVal;
...
EMGMResponse OPCUA_MGR::addMgmtObjectInstance() {
  ...
  UA_StatusCode status =
      UA_Server_addObjectNode(mUaHandler.getUAServer(), UA_NODEID_STRING(smNamespaces[1], smMgmtName),
                              UA_NODEID_NUMERIC(smNamespaces[0], UA_NS0ID_OBJECTSFOLDER),
                              UA_NODEID_NUMERIC(smNamespaces[0], UA_NS0ID_ORGANIZES),
                              UA_QUALIFIEDNAME(smNamespaces[1], smMgmtName), mMgmtTypeId, oAttr, nullptr, &mMgmtNodeId);
...
EMGMResponse OPCUA_MGR::createIEC61499ResourceObjectType(UA_Server *paServer) {
  EMGMResponse eRetVal = EMGMResponse::InvalidState;
  if (defineIEC61499ResourceObjectType(paServer) != EMGMResponse::Ready)
    return eRetVal;
  if (addCreateFBMethod(paServer) != EMGMResponse::Ready)
    return eRetVal;
  if (addCreateConnectionMethod(paServer) != EMGMResponse::Ready)
    return eRetVal;
  if (addWriteFBMethod(paServer) != EMGMResponse::Ready)
    return eRetVal;
  if (addStartFBMethod(paServer) != EMGMResponse::Ready)
    return eRetVal;
  if (addStopFBMethod(paServer) != EMGMResponse::Ready)
    return eRetVal;
  if (addResetFBMethod(paServer) != EMGMResponse::Ready)
    return eRetVal;
  if (addKillFBMethod(paServer) != EMGMResponse::Ready)
    return eRetVal;
  if (addDeleteFBMethod(paServer) != EMGMResponse::Ready)
    return eRetVal;
  ...
  if (addRemoveWatchMethod(paServer) != EMGMResponse::Ready)
    return eRetVal;
  if (addTriggerEventMethod(paServer) != EMGMResponse::Ready)
    return eRetVal;
  if (addForceValueMethod(paServer) != EMGMResponse::Ready)
    return eRetVal;
...
EMGMResponse OPCUA_MGR::addResourceObjectInstance(char *paResourceName, UA_NodeId &paNodeId, UA_NodeId paParentNodeId) {
  ...
  UA_StatusCode status = UA_Server_addObjectNode(
      mUaHandler.getUAServer(), UA_NODEID_NULL, paParentNodeId, UA_NODEID_NUMERIC(smNamespaces[0], UA_NS0ID_ORGANIZES),
      UA_QUALIFIEDNAME(smNamespaces[1], paResourceName), mResourceTypeId, oAttr, paResourceName, &paNodeId);
  if (status != UA_STATUSCODE_GOOD) {
    return EMGMResponse::InvalidState;
  }
  return eRetVal;
...
EMGMResponse OPCUA_MGR::addCreateResourceMethod(UA_Server *paServer) {
  ...
  return addMethodNode(paServer, smCreateResMethodName, mMgmtTypeId, createResAttr, inputArguments, 2, &outputArgument,
                       1, &onCreateResource);
}
...
EMGMResponse OPCUA_MGR::addCreateFBMethod(UA_Server *paServer) {
  ...
  return addMethodNode(paServer, smCreateFBMethodName, mResourceTypeId, createFBAttr, inputArguments, 2, nullptr, 0,
                       &onCreateFB);
}
...
EMGMResponse OPCUA_MGR::addCreateConnectionMethod(UA_Server *paServer) {
  ...
  return addMethodNode(paServer, smCreateConnMethodName, mResourceTypeId, createConnAttr, inputArguments, 2, nullptr, 0,
                       &onCreateConnection);
}
...
EMGMResponse OPCUA_MGR::addWriteDeviceMethod(UA_Server *paServer) {
  ...
  return addMethodNode(paServer, smWriteDevMethodName, mMgmtTypeId, writeDevAttr, &inputArgument, 1, nullptr, 0,
                       &onWriteDevice);
}
...
EMGMResponse OPCUA_MGR::addWriteResourceMethod(UA_Server *paServer) {
  ...
  return addMethodNode(paServer, smWriteResMethodName, mMgmtTypeId, writeResAttr, inputArguments, 2, nullptr, 0,
                       &onWriteResource);
}
...
EMGMResponse OPCUA_MGR::addWriteFBMethod(UA_Server *paServer) {
  ...
  return addMethodNode(paServer, smWriteFBMethodName, mResourceTypeId, writeFBAttr, inputArguments, 2, nullptr, 0,
                       &onWriteFB);
}
...
EMGMResponse OPCUA_MGR::addStartDeviceMethod(UA_Server *paServer) {
  ...
  return addMethodNode(paServer, smStartDevMethodName, mMgmtTypeId, startDevAttr, nullptr, 0, nullptr, 0,
                       &onStartDevice);
}
...
EMGMResponse OPCUA_MGR::addStartResourceMethod(UA_Server *paServer) {
  ...
  return addMethodNode(paServer, smStartResMethodName, mMgmtTypeId, startResAttr, &inputArgument, 1, nullptr, 0,
                       &onStartResource);
}
...
EMGMResponse OPCUA_MGR::addStartFBMethod(UA_Server *paServer) {
  ...
  return addMethodNode(paServer, smStartFBMethodName, mResourceTypeId, startFBAttr, &inputArgument, 1, nullptr, 0,
                       &onStartFB);
}
...
EMGMResponse OPCUA_MGR::addStopResourceMethod(UA_Server *paServer) {
  ...
  return addMethodNode(paServer, smStopResMethodName, mMgmtTypeId, stopResAttr, &inputArgument, 1, nullptr, 0,
                       &onStopResource);
}
...
EMGMResponse OPCUA_MGR::addStopFBMethod(UA_Server *paServer) {
  ...
  return addMethodNode(paServer, smStopFBMethodName, mResourceTypeId, stopFBAttr, &inputArgument, 1, nullptr, 0,
                       &onStopFB);
}
...
EMGMResponse OPCUA_MGR::addResetDeviceMethod(UA_Server *paServer) {
  ...
  return addMethodNode(paServer, smResetDevMethodName, mMgmtTypeId, resetDevAttr, nullptr, 0, nullptr, 0,
                       &onResetDevice);
}
...
EMGMResponse OPCUA_MGR::addResetResourceMethod(UA_Server *paServer) {
  ...
  return addMethodNode(paServer, smResetResMethodName, mMgmtTypeId, resetResAttr, &inputArgument, 1, nullptr, 0,
                       &onResetResource);
}
...
EMGMResponse OPCUA_MGR::addResetFBMethod(UA_Server *paServer) {
  ...
  return addMethodNode(paServer, smResetFBMethodName, mResourceTypeId, resetFBAttr, &inputArgument, 1, nullptr, 0,
                       &onResetFB);
}
...
EMGMResponse OPCUA_MGR::addKillResourceMethod(UA_Server *paServer) {
  ...
  return addMethodNode(paServer, smKillResMethodName, mMgmtTypeId, killResAttr, &inputArgument, 1, nullptr, 0,
                       &onKillResource);
}
...
EMGMResponse OPCUA_MGR::addKillFBMethod(UA_Server *paServer) {
  ...
  return addMethodNode(paServer, smKillFBMethodName, mResourceTypeId, killFBAttr, &inputArgument, 1, nullptr, 0,
                       &onKillFB);
}
...
EMGMResponse OPCUA_MGR::addDeleteResourceMethod(UA_Server *paServer) {
  ...
  return addMethodNode(paServer, smDeleteResMethodName, mMgmtTypeId, deleteResAttr, &inputArgument, 1, nullptr, 0,
                       &onDeleteResource);
}
...
EMGMResponse OPCUA_MGR::addDeleteFBMethod(UA_Server *paServer) {
  ...
  return addMethodNode(paServer, smDeleteFBMethodName, mResourceTypeId, deleteFBAttr, &inputArgument, 1, nullptr, 0,
                       &onDeleteFB);
}
...
EMGMResponse OPCUA_MGR::addDeleteConnectionMethod(UA_Server *paServer) {
  ...
  return addMethodNode(paServer, smDeleteConnMethodName, mResourceTypeId, deleteConnAttr, inputArguments, 2, nullptr, 0,
                       &onDeleteConnection);
}
...
EMGMResponse OPCUA_MGR::addQueryResourcesMethod(UA_Server *paServer) {
  ...
  return addMethodNode(paServer, smQueryResourcesMethodName, mMgmtTypeId, queryResourcesAttr, nullptr, 0,
                       &outputArgument, 1, &onQueryResources);
}
...
EMGMResponse OPCUA_MGR::addAddWatchMethod(UA_Server *paServer) {
  ...
  return addMethodNode(paServer, smAddWatchMethodName, mResourceTypeId, addWatchAttr, &inputArgument, 1, nullptr, 0,
                       &onAddWatch);
}
...
EMGMResponse OPCUA_MGR::addReadWatchesMethod(UA_Server *paServer) {
  ...
  return addMethodNode(paServer, smReadWatchesMethodName, mMgmtTypeId, readWatchesAttr, nullptr, 0, &outputArgument, 1,
                       &onReadWatches);
}
...
EMGMResponse OPCUA_MGR::addRemoveWatchMethod(UA_Server *paServer) {
  ...
  return addMethodNode(paServer, smRemoveWatchMethodName, mResourceTypeId, removeWatchAttr, &inputArgument, 1, nullptr,
                       0, &onRemoveWatch);
}
...
EMGMResponse OPCUA_MGR::addTriggerEventMethod(UA_Server *paServer) {
  ...
  return addMethodNode(paServer, smTriggerEventMethodName, mResourceTypeId, triggerEventAttr, &inputArgument, 1,
                       nullptr, 0, &onTriggerEvent);
}
...
EMGMResponse OPCUA_MGR::addForceValueMethod(UA_Server *paServer) {
  ...
  return addMethodNode(paServer, smForceValueMethodName, mResourceTypeId, forceValueAttr, inputArguments, 2, nullptr, 0,
                       &onForceValue);
}
...
EMGMResponse OPCUA_MGR::addClearForceMethod(UA_Server *paServer) {
  ...
  return addMethodNode(paServer, smClearForceMethodName, mResourceTypeId, clearForceAttr, &inputArgument, 1, nullptr, 0,
                       &onClearForce);
}
...
EMGMResponse OPCUA_MGR::addMethodNode(UA_Server *paServer,
  ...
  UA_StatusCode status = UA_Server_addMethodNode(
      ...
      paAttr, paCallback, paInArgSize, paInArgs, paOutArgSize, paOutArgs, nodeContext == nullptr ? this : nodeContext,
      &methodId);
...
UA_StatusCode OPCUA_MGR::addReference(UA_Server *paServer, UA_NodeId &paMethodId) {
  return UA_Server_addReference(paServer, paMethodId, UA_NODEID_NUMERIC(0, UA_NS0ID_HASMODELLINGRULE),
...
EMGMResponse
OPCUA_MGR::addExtraMethods(UA_Server *paServer, UA_NodeId paParentNodeId, std::vector<MethodInformation> &paMethods) {
  for (auto &method : paMethods) {
    ...
    if (auto result = addMethodNode(paServer, method.mMethodName.data(), paParentNodeId, attributes,
                                    method.mInArguments.data(), method.mInArguments.size(), method.mOutArguments.data(),
                                    method.mOutArguments.size(), method.mCallback, method.mNodeContext);
        result != EMGMResponse::Ready) {
